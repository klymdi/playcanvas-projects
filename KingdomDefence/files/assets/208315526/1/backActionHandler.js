...
//         document.addEventListener("tizenhwkey", function(event) { // BACK на Tizen
...
//         // document.addEventListener("tizenhwkey" && "keydown", function(event) {
//         //     // const logMessage = `keyup event: ${event.key} (code: ${event.keyCode})`;
            
//         //     // if (Main.instance.backEnventHandlerField && Main.instance.backEnventHandlerField.element) {
//         //     //     Main.instance.backEnventHandlerField.element.key = logMessage;
//         //     // }
